...
T = {
 ...
 # Quiz / level-test result screens.
 "Perfect!": ("Perfekt!", "Ідеально!"),
 "Great job!": ("Großartig!", "Чудова робота!"),
 "Good work!": ("Gut gemacht!", "Гарна робота!"),
 "Keep learning!": ("Lerne weiter!", "Продовжуй вчитися!"),
